...
CREATE TABLE IF NOT EXISTS attendance_records (
    ...
    status VARCHAR(30) NOT NULL DEFAULT 'ABSENT', -- PRESENT, ABSENT, HALF_DAY, LEAVE
    remarks TEXT,
...
CREATE TABLE IF NOT EXISTS leave_requests (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL,
    leave_type VARCHAR(30) NOT NULL, -- PAID, SICK, UNPAID
    start_date DATE NOT NULL,
    end_date DATE NOT NULL,
    total_days INT NOT NULL DEFAULT 1,
    reason TEXT NOT NULL,
    status VARCHAR(30) NOT NULL DEFAULT 'PENDING', -- PENDING, APPROVED, REJECTED, WITHDRAWN, RECALLED, CANCELLED
    hr_comments TEXT,
...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    type VARCHAR(30) NOT NULL DEFAULT 'SYSTEM', -- LEAVE, ATTENDANCE, PAYROLL, PROFILE, SYSTEM
