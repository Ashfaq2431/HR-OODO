  ...
  return (
    <div style={{ maxWidth: '850px', margin: '0 auto' }}>
      <div style={{ marginBottom: '1.75rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h1 className="page-title">Administrative Alerts & Action Queue</h1>
          <p className="page-subtitle">Real-time feed of employee leave requests, early return applications, and payroll logs</p>
        </div>
      ...
      <div className="card">
        {notifications.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '3rem 1rem', color: 'var(--slate-400)' }}>
            ...
            <h3 style={{ fontSize: '1rem', color: 'var(--slate-600)', marginBottom: '0.25rem' }}>No System Alerts</h3>
            <p style={{ fontSize: '0.875rem' }}>All pending administrative items are cleared.</p>
          </div>
        ) : (
